...
import main.java.assignmentlist.assignmentController;
...
public class Controller implements Initializable{
    ...
    private void onRewardClicked(ActionEvent e) {
        ...
        try {
    		Parent rewardParent = FXMLLoader.load(getClass().getResource("/main/java/rewardSystem/RewardMain.fxml"));
    ...
    private void onAssignmentClicked(ActionEvent e) {
        ...
        try {
    		...
    		Parent assignmentParent = FXMLLoader.load(getClass().getResource("/main/java/assignmentlist/assignmentlist.fxml"));
